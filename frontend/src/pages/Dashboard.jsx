...
import { FileText, ChevronRight, Shield, DollarSign, Package, AlertTriangle } from 'lucide-react';
    ...
    <Layout>
      <div className="p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-8">
          {/* Carte 1 - Statut de l'inventaire (VERT) */}
          <div className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200">
            <div className="p-6">
              ...
              <h3 className="text-3xl font-bold text-gray-800 text-center mb-2">Bien</h3>
              <p className="text-gray-600 text-sm text-center mb-4">Statut de l'inventaire</p>
            </div>
            {/* Bande colorée en bas avec bouton */}
            <div className="bg-green-100 px-6 py-3">
              <button className="text-green-700 text-sm font-medium hover:underline flex items-center justify-center w-full gap-1">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200">
            <div className="p-6">
              ...
              <h3 className="text-3xl font-bold text-gray-800 text-center mb-2">4.800.432 FCFA</h3>
              <div className="text-gray-600 text-sm text-center mb-4 flex items-center justify-center gap-2">
                <span>Revenu :</span>
                <select 
            ...
            <div className="bg-yellow-100 px-6 py-3">
              <button className="text-yellow-700 text-sm font-medium hover:underline flex items-center justify-center w-full gap-1">
                Afficher le rapport détaillé
                <ChevronRight size={16} />
              </button>
            </div>
          ...
          {/* Carte 3 - Médicaments disponibles (BLEU) */}
          <div className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200">
            <div className="p-6">
              <div className="flex justify-center mb-4">
              ...
              <h3 className="text-3xl font-bold text-gray-800 text-center mb-2">{stats.total_medicaments}</h3>
              <p className="text-gray-600 text-sm text-center mb-4">Médicaments disponibles</p>
            </div>
            {/* Bande colorée en bas avec bouton */}
            <div className="bg-blue-100 px-6 py-3">
              <button 
                onClick={() => navigate('/medicaments')}
                className="text-blue-700 text-sm font-medium hover:underline flex items-center justify-center w-full gap-1"
              >
          ...
          {/* Carte 4 - Pénurie de médicaments (ROUGE) */}
          <div className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200">
            <div className="p-6">
              <div className="flex justify-center mb-4">
              ...
              <h3 className="text-3xl font-bold text-gray-800 text-center mb-2">{stats.penuries}</h3>
              <p className="text-gray-600 text-sm text-center mb-4">Pénurie de médicaments</p>
            </div>
            {/* Bande colorée en bas avec bouton */}
            <div className="bg-red-100 px-6 py-3">
              <button className="text-red-700 text-sm font-medium hover:underline flex items-center justify-center w-full gap-1">
                Résoudre maintenant
                <ChevronRight size={16} />
              </button>
            </div>
